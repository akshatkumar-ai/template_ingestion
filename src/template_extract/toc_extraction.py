...
from src.template_extract.general_prompts import extract_toc_prompt_mardown_json

# Add the parent directory to the path to access utils
sys.path.append(os.path.abspath(os.path.join(os.path.dirname(__file__), "..")))
from src.template_extract.general import (
    get_config,
    generate,
    get_bedrock_client,
    write_json_to_file,
...
from src.template_extract.logger_config import logger
